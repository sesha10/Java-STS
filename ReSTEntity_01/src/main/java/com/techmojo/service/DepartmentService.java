...
public class DepartmentService {
	...
	public Department terminate(int id) throws InvalidDepartmentIdException, SQLException {
		Department deletedDepartment = searchDepartment(id);
		List<Employee> employees = employeeRepo.findAllByDepartment(deletedDepartment);
		if (!employees.isEmpty()) {
			throw new SQLException("Employees present in Department: " + id);
		}
